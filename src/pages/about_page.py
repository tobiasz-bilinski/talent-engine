...
class AboutPage:
    PAGE_URL = "/about"
    twitter_button = (
        By.CSS_SELECTOR, "a[title='GitHub on Twitter']")
    facebook_button = (
        By.CSS_SELECTOR, "a[title='GitHub on Facebook']")
    youtube_button = (
        By.CSS_SELECTOR, "a[title='GitHub on YouTube']")
    linkedin_button = (
        By.CSS_SELECTOR, "a[title='GitHub on LinkedIn']")
